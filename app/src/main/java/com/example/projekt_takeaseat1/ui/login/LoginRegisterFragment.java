...
public class LoginRegisterFragment extends Fragment {
        ...
        loginRegisterViewModel.getUserMutableLiveData().observe(this, new Observer<FirebaseUser>() {
            ...
            public void onChanged(FirebaseUser firebaseUser) {
                if (firebaseUser != null) {
                    Navigation.findNavController(getView()).navigate(R.id.action_loginRegisterFragment_to_bottom_nav); //Når man har logget ind kommer man her ind
                }
            }
        });
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        registerButton = view.findViewById(R.id.fragment_loginregister_registerbutton);
